...
#### 1. Включити кешування response на файловой системе

За замовчуванням, OkHttt не кешує відповіді які є дозвилині для кешування шляхом включення HTTP заголовку `Cache-Control`. Тому Ваш кліент може витрачати час та ресурси мережі запитуючи один і той самий ресурс, знову і знову, а не просто прочитати копію збережену після першого запиту.
...
![Stetho inspector network](images/stetho-inspector-network.png)
